// Journal of daily events over a 90 day period. Each object contains an array of events that happened during the day, and a boolean value for whether a transformation occured that day
var JOURNAL = [
...
// Adding a new event to each entry that satisfies the most correlating events: eating peanuts and not brushing my teeth
for (let entry of JOURNAL) {
...
if (value === 1) {
  console.log("A correlation value of 1 means that I turn into a werewolf on the days when I eats peanut and don't brush my teeth.");
}